...
public final class ClientServiceProxyFactory implements InvocationHandler {
    ...
    private static final boolean LOG_ERROR_CONTENT = JelConfig.getBooleanProperty("org.lorislab.jel.rs.client.log.error.content", true);
    
    private static final String[] EMPTY = {};

    private final static Logger LOGGER = LoggerFactory.getLogger(ClientServiceProxyFactory.class);
