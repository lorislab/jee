 ...
 */
package org.lorislab.jel.cdi.interceptor.annotations;

/**
 * The rest service method annotation for the interceptor.
 *
 * @see RestServiceMethod
 *
...
@Target({TYPE, METHOD})
@Retention(RUNTIME)
public @interface CdiServiceMethod {
