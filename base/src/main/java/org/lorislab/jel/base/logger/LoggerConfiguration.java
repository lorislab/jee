...
public final class LoggerConfiguration {
     ...
     * The start message pattern.
     */
    private static final String TRACE_EXCEPTION_MESSAGE_PATTERN = "Exception in [{}] {}:{} error ";
    /**
     * The start message pattern system property.
     */
    private static final String TRACE_EXCEPTION_MESSAGE_PROPERTY = "org.lorislab.jel.logger.trace.exception";
    /**
    ...
    public static final String PATTERN_TRACE_EXCEPTION;
    ...
    static {
        ...
        PATTERN_TRACE_EXCEPTION= System.getProperty(TRACE_EXCEPTION_MESSAGE_PROPERTY, TRACE_EXCEPTION_MESSAGE_PATTERN);
